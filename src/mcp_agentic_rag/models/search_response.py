...
class SearchResponse(BaseModel):
    ...
    results: List[Union[VectorMatch, WebResult]] = Field(default_factory=list, description="Combined and ranked results")
    ...
    def get_sorted_results(self, by_score: bool = True) -> List[Union[VectorMatch, WebResult]]:
